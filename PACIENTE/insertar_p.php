        ...
        <div id="wrapper" class="container">  
                 <center>
                    ...
                    <h1>INGRESAR PACIENTES:</h1><hr>
                        <form  method="POST" name="form-work" action="INSERCIONES/PACIENTE/guardar_p.php" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label for="Prevision">SELECCIONE PREVISION DEL PACIENTE:</label>
                                      <select class="form-control" name="Prevision" placeholder="SELECCIONE UNA" type="select">>
                                        <option value="volvo">FONASA</option>
                                        <option value="saab">ISAPRE</option>
                                        <option value="opel">COOPERATIVA</option>
                                        <option value="audi">CAPREDENA</option>
                                        <option value="audi">SEGURO MEDICO DE VIAJE</option>
                                        <option value="audi">SIN PREVISION</option>
